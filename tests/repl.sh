...
if gcc -Iinclude -Igen -Isrc -O2 -o "$D/flash_guard" tests/flash_guard.c \
       src/csp_transport.c src/csp_console.c src/csp_states.c src/csp_flash.c src/csp_crc.c port/csp_devices.c port/csp_socketcan.c port/csp_udp.c port/csp_flash_host.c \
