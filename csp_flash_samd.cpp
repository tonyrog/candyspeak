/*
  VENDORED from cmaglie/FlashStorage v1.0.0 -- FlashClass only, see
  csp_flash_samd.h for why the FlashAsEEPROM layer is left out. Unmodified except
  for the include rename. Original notice follows.
...
// This file sits in the sketch directory, so arduino-cli compiles it for EVERY
// target -- but NVMCTRL only exists on SAMD. Empty translation unit elsewhere.
